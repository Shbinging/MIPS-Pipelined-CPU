...
class InstrDecode extends Module{
    ...
    val decoded_instr = ListLookup(if_id_reg.instr, List(rd, RS_SEL, RT_SEL, ZERO_EXT_SEL, ALU_ID, ALU_ADD_OP, 0.U, 0.U, 0.U),
        Array(
            ...
            BLTZAL -> List(31.U(5.W), RS_SEL, DontCare, SIGN_EXT_SEL, BRU_ID, BRU_BLTZAL_OP, 31.U, rs, 0.U),
            BGEZAL -> List(31.U(5.W), RS_SEL, DontCare, SIGN_EXT_SEL, BRU_ID, BRU_BGEZAL_OP, 31.U, rs, 0.U),
