...
class InstrDecode extends Module{
    ...
    val decoded_instr = ListLookup(if_id_reg.instr, List(rd, RS_SEL, RT_SEL, ZERO_EXT_SEL, ALU_ID, ALU_ADD_OP, 0.U, 0.U, 0.U),
        Array(
            ...
            SW  -> List(rt, RS_SEL, IMM_SEL, SIGN_EXT_SEL, LSU_ID, LSU_SW_OP, rt, rs, 0.U),
            SH  -> List(rt, RS_SEL, IMM_SEL, SIGN_EXT_SEL, LSU_ID, LSU_SH_OP, rt, rs, 0.U),
            SB  -> List(rt, RS_SEL, IMM_SEL, SIGN_EXT_SEL, LSU_ID, LSU_SB_OP, rt, rs, 0.U),
            SWL -> List(rt, RS_SEL, IMM_SEL, SIGN_EXT_SEL, LSU_ID, LSU_SWL_OP, rt, rs, 0.U),
            SWR -> List(rt, RS_SEL, IMM_SEL, SIGN_EXT_SEL, LSU_ID, LSU_SWR_OP, rt, rs, 0.U),     
