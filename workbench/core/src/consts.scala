...
trait ExecUnitIndices {
  ...
  val LSU_FUNC_B = 0.U(OPCODE_WIDTH.W)
  val LSU_FUNC_BU = 1.U(OPCODE_WIDTH.W)
  val LSU_FUNC_H = 2.U(OPCODE_WIDTH.W)
  val LSU_FUNC_HU = 3.U(OPCODE_WIDTH.W)
  val LSU_FUNC_W = 4.U(OPCODE_WIDTH.W)
  val LSU_FUNC_WU = 5.U(OPCODE_WIDTH.W)
  val LSU_FUNC_RWL = 6.U(OPCODE_WIDTH.W)
  val LSU_FUNC_RWR = 7.U(OPCODE_WIDTH.W)
  val LSU_FUNC_WWL = 8.U(OPCODE_WIDTH.W)
  val LSU_FUNC_WWR = 9.U(OPCODE_WIDTH.W)
  //MDU
  ...
  //PRU
  val PRU_SYSCALL_OP = 0.U(OPCODE_WIDTH.W)
  val PRU_BREAK_OP = 1.U(OPCODE_WIDTH.W)
  val PRU_EXCEPT_OP = 2.U(OPCODE_WIDTH.W) 
  val PRU_CACHE_OP = 3.U(OPCODE_WIDTH.W)
  val PRU_TLBP_OP  = 4.U(OPCODE_WIDTH.W)
  val PRU_TLBR_OP  = 5.U(OPCODE_WIDTH.W)
  val PRU_TLBWI_OP = 6.U(OPCODE_WIDTH.W)
  val PRU_TLBWR_OP = 7.U(OPCODE_WIDTH.W)
